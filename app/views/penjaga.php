		...
		<div class="col-md-3">
			...
			foreach ($lok as $l) { ?>
				<div class="box">
					...
					<div>
						<?php $x = $this->M_crud->get_max_id('transaksi', 'no_antrian', array('id_loket' => $l->id_loket, 'tgl' => date('dmY'), 'id_loket !=' => $loket->id_loket ))->row('no_antrian');  
						?>
						<h1 style="color:#000"><?php echo $x; ?></h1>
					</div>
				</div>
			<?php
		}
