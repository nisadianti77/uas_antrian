		...
		<div class="row">
			...
			<div class="col-md-4">
				...
				if (empty($this->session->userdata('level'))) { ?>
					<a class="footer" href="<?php echo site_url('welcome/login/'); ?>">login <strong></strong> <?php echo (ENVIRONMENT === 'development') ? '</strong>' : '' ?></a>
					<a class="footer" href="<?php echo site_url('welcome/antrian/'); ?>">Nomer Antrian</a>
					<a class="footer" href="<?php echo site_url('welcome/pelayanan/'); ?>">Menu Antrian</a>
					<a class="footer" href="<?php echo site_url('welcome/'); ?>">Home</a>
				<?php } else { ?>
